 ...
 * @param def {string}
 * @param data_type {'positive' | 'positive_int' | 'string' | 'date' | 'nul_str' | 'mail_list'}
 * @return {number | Date | string | undefined | string[]}
 */
E.readline = (question, def, data_type)=>etask(function* (){
    this.finally(()=>{
